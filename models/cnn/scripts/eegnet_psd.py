...
for idx, subj in enumerate(subjects):
    ...
    for n_ch in n_chans:
        ...
        for tp_class_weight in tp_class_weights:
            ...
            for bad_ch in subj_bad_channels:
                if bad_ch in subj_epochs.ch_names:
                    subj_epochs.drop_channels(bad_ch)
            ...
            if subj in validation_data.keys():
                ...
                for bad_ch in subj_bad_channels:
                    if bad_ch in subj_validation_epochs.ch_names:
                        subj_validation_epochs.drop_channels(bad_ch)
